...
INSERT INTO supermarkets (slug, name, logo_url, website_url, color, is_active) VALUES
  ...
  ('plus',       'Plus',          NULL, 'https://www.plus.nl',         '#E30613', false),
  ('dirk',       'Dirk',          NULL, 'https://www.dirk.nl',         '#E4002B', false),
  ('hoogvliet',  'Hoogvliet',     NULL, 'https://www.hoogvliet.com',   '#009900', false),
  ('vomar',      'Vomar',         NULL, 'https://www.vomar.nl',        '#E2001A', true),
  ('poiesz',     'Poiesz',        NULL, 'https://www.poiesz-supermarkten.nl', '#00529B', false),
  ('spar',       'Spar',          NULL, 'https://www.spar.nl',         '#007A3D', false),
  ('dekamarkt',  'DekaMarkt',     NULL, 'https://www.dekamarkt.nl',    '#C8002D', false)
